...
<body>
  <%! String User;%>
    ...
    <%
            ...
            ResultSet rs = admi.Marca_a_editar(id);
            rs.next();
  ...
  <section id="secondary_bar">
	...
	<article class="module width_full">
			<header><h3>Editar Marca</h3></header>
                        <form action="Editar_Eliminar_Marcas.do" method="post" enctype="multipart/form-data">
				<div class="module_content">
						<fieldset>
							<label>Nombre Marca</label>
                                                        <input type="text" value="<%=nombreMarca%>" name="nombreMarca" required="">
						</fieldset>

						<fieldset>
                                                    <img src="images/Marcas/<%=urlImage%>" width="150" height="150" />
                                                     <input type="text" value="<%=id%>" name="idMarca" style="visibility: hidden;">
                                                    <input type="file" name="file" required="Actualiza Imagen">
						</fieldset>
